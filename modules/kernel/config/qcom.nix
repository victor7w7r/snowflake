    ...
    lib.mkMerge [
      {
        ...
        DRM_UDL = setupDenial isDenied module;
        ...
        HID_BATTERY_STRENGTH = setupDenial isDenied yes;
        ...
        LEDS_CLASS_FLASH = setupDenial isDenied yes;
        LEDS_TRIGGER_ACTIVITY = setupDenial isDenied yes;
        LEDS_TRIGGER_BACKLIGHT = setupDenial isDenied yes;
        LEDS_TRIGGER_ONESHOT = setupDenial isDenied yes;
        LEDS_TRIGGER_PATTERN = setupDenial isDenied yes;
        NETLINK_DIAG = setupDenial isDenied module;
        NET_SCH_HTB = setupDenial isDenied yes;
        NET_SCH_MULTIQ = setupDenial isDenied yes;
        NET_SCH_PRIO = setupDenial isDenied yes;
        NULL_TTY = setupDenial isDenied yes;
        ...
        QCOM_RPROC_COMMON = setupDenial isDenied yes;
