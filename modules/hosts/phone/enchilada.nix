...
}:
{
  ...
  #mount -o lazytime,noatime,inline_xattr,inline_data,inline_dentry,flush_merge,checkpoint_merge,gc_merge /dev/sdi17 /mnt && rm -rf /mnt/store/* && tar --zstd -xvf store-enchilada.tar.zst -C /mnt/store/
